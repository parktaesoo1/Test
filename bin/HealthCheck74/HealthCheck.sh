...
printf "%s\n" "=================================================="
printf "\e[1;34m %-10s\e[0m \n" "## JBOSS EAP 7.2 HEALTHCHECK V0.1 ##"
printf "%s\n" "=================================================="
...
MEMORY_INFO=`./jboss-cli.sh --command="/core-service=platform-mbean/type=memory:read-resource(include-runtime=true,recursive=true,recursive-depth=10)" > MEMORY_INFO.txt`
...
$JAVA_HOME/bin/jstat -gcutil $PID |grep -v "S0" > gc.txt 2>&1
