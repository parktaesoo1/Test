...
export JBOSS_MODULEPATH=$JBOSS_HOME/modules:$JBOSS_HOME/modules.ext:/was/jboss/testDir/
# JVM Options : Server
...
# 7.1
#export JAVA_OPTS=" $JAVA_OPTS -Djgroups.tcpping.initial_hosts=10.65.40.215[7700],10.65.40.216[7700], "
#export JAVA_OPTS=" $JAVA_OPTS -Djboss.bind.address.private=$BIND_ADDR"
...
# Use log4j in application -  EAP 6.x
